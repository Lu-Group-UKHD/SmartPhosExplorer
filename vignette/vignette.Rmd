...
* If the user has already clicked on process button in the prepocessing options panel, the processed assay will also be saved as a summarized experiment object along with the original multiAssayExperiment object when clicking on the save button. Same with the filtered or subsetted assay. The multiAssayExperiment object will have _mae_ keyword in the saved Rds object. 
