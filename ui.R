...
navbarPage("SmartPhos explorer",
           ...
           tabPanel("Preprocesing",
                    h5("Updated on 03.01.2024, please check the Update Notes panel for detailed information"),
           ...
           tabPanel("Time series clustering",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        sliderInput("seleProbCut", "Cut-off for cluster membership probability", 0, 1, 0.6, 0.05),
