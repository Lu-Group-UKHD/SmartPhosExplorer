           ...
           tabPanel("Preprocesing",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        bsCollapse(id = "collapse1", open = "Upload",
                                   bsCollapsePanel("Upload",
                                                   ...
                                                   radioButtons("upload", "Select the upload method:", 
                                                                c("Upload a R object", "Upload a zip file"),
                                                                inline = TRUE),
                                                   conditionalPanel(
                        ...
                        hr(),
                        h4("Save results or load saved results", style = "color:steelblue;font-weight: bold"),
           ...
           tabPanel("Differential expression",
                    ...
                    sidebarLayout(
                      sidebarPanel(
                        ...
                        radioButtons("seleCompare", "Compare between:",
                                     c("treatments per time", "time points per treatment")),
                        conditionalPanel(condition = "input.seleCompare == 'treatments per time'",
                                         uiOutput("treat1Box"),
                                         uiOutput("treat2Box"),
                                         uiOutput("timeBox")),
                        conditionalPanel(condition = "input.seleCompare == 'time points per treatment'",
                                         uiOutput("time1Box"),
                                         uiOutput("time2Box"),
                                         uiOutput("treatBox")),
                      ...
                      sidebarPanel(
                        ...
                        conditionalPanel(condition = "input.seleSourceKinase == 'Time-series cluster'",
                                         ...
                                         conditionalPanel(condition = "input.seleKinaseTimeMethod == 'association'",
                                                          radioButtons("seleAssoMethod", "Select method to estimate association (enrichment score)",
                                                                       c("Fisher's exact test", "GSEA")))),
